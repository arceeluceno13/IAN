...
<div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4 ml-4 pr-4">
        {/* First Column */}
        <div className="h-screen py-3 flex flex-col">
          <button
            className="relative w-full bg-gradient-to-tl from-zinc-900 to-green-600 rounded-2xl p-5 text-white text-xl font-medium shadow-l border border-white flex items-center shadow-lg hover:text-green-400 transition duration-300"
          ...
          <div className="flex flex-col flex-grow border border-gray-300 rounded-2xl py-4 px-4 mt-3 shadow-xl justify-around">
            ...
            <div className="my-3 pl-5">
              <div className="flex">
                <div className="w-2 h-2 rounded-full bg-green-700 mt-2 mr-1"></div>
                <p className="text-sm">Transportation</p>
              </div>
              <div className="flex">
                <div className="w-2 h-2 rounded-full bg-red-600 mt-2 mr-1"></div>
                <p className="text-sm">School</p>
              </div>
              <div className="flex">
                <div className="w-2 h-2 rounded-full bg-blue-900 mt-2 mr-1"></div>
                <p className="text-sm">Food</p>
              </div>
              <div className="flex">
                <div className="w-2 h-2 rounded-full bg-yellow-500 mt-2 mr-1"></div>
                <p className="text-sm">Online Orders</p>
              </div>
              <div className="flex">
                <div className="w-2 h-2 rounded-full bg-pink-500 mt-2 mr-1"></div>
                <p className="text-sm">Others</p>
              </div>
            </div>

            <div className="h-[200px] overflow-y-scroll rounded-2xl pr-2 expense-history">
        ...
        {/* Second Column */}
        <div className="py-3 h-screen flex-col flex-1">
          <div className="border border-gray-300 rounded-2xl shadow-xl py-3 px-4 ">
            ...
            <div className="h-[235px] overflow-y-scroll rounded-2xl pr-2 expense-history">
              <div className="space-y-1">
                <MonthExpenseHistory />
                <MonthExpenseHistory />
                <MonthExpenseHistory />
      ...
      <AddExpenseModal isOpen={isModalOpen} onClose={handleModalToggle} />
    </div>
  );
}